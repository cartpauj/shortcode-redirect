...
2. Update the version number in **all three** locations:
   - `scr.php` — `Version: X.Y.Z` in the plugin header
...
- Detects the version from `scr.php`
...
1. Verify the GitHub Release appears at https://github.com/cartpauj/shortcode-redirect/releases
2. Verify the new version appears on https://wordpress.org/plugins/shortcode-redirect/
